...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Fridge.ListItems(context.Background())
	if userAgent != fmt.Sprintf("NoraTestProject10000/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Fridge.ListItems(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Fridge.ListItems(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Fridge.ListItems(deadlineCtx)
		if err == nil {
